...
class Sqlite  {
	...
	public static insertPerson(name: string): void {
		const INSERT_PERSON = `INSERT INTO PERSON ('name') values ('${name}')`
	...
	public static deleteAll(): void {
		const DELETE_ALL = `DELETE FROM PERSON`
	...
	public static selectPerson(name: string): Promise<string> {
		const SELECT_PERSON = `SELECT id, name FROM PERSON WHERE name = '${name}'`
	...
	public static selectAll(): Promise<Person[]> {
		const SELECT_ALL = `SELECT id, name FROM PERSON`
